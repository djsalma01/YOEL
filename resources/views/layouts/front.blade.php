...
">
                ...
                <div class="mobile-menu-area electro-menu d-md-block col-md-12 col-lg-12 col-12 d-lg-none d-xl-none" style="
    z-index:1;
background-color: rgba(10,10,10,.3)!important;    position: fixed;
    top: 0;
">
                <div class="logo-3">
                    <a href="{{route('home')}}">
    ...
    <li><a href="{{url('/products/search')}}">Shop </a></li>
